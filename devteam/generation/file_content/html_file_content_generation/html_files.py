...
instructions=f"""
Generate the content of the html file. Analyze the provided architecture carefully to create
...
async def get_html_file_content(
    user_prompt: str,
    system_prompt
) -> dict:
    try:
        ...
        validate_chat_response(response, get_html_file_generation_output_schema())
        response_dict = json.loads(response)
        return response_dict
    except Exception as e:
        print(f"Error in get_html_file_content: {e}")
        raise e