...
instructions=f"""
Generate the content of the .env file. Analyze the provided architecture carefully to identify all necessary 
...
async def get_env_file_content(
    user_prompt: str,
    system_prompt
) -> dict:
    try:
        ...
        validate_chat_response(response, get_env_var_content_output_schema())
        response_dict = json.loads(response)
        return response_dict
    except Exception as e:
        print(f"Error in get_env_file_content: {e}")
        raise e
