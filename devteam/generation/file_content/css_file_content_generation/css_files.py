...
instructions=f"""
Generate the content of the css file. Analyze the provided architecture carefully to create
...
async def get_css_file_content(
    user_prompt: str,
    system_prompt
) -> dict:
    try:
        ...
        validate_chat_response(response, get_css_file_generation_output_schema())
        response_dict = json.loads(response)
        return response_dict
    except Exception as e:
        print(f"Error in get_css_file_content: {e}")
        raise e
