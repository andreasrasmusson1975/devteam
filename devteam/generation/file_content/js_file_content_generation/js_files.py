...
instructions=f"""
Generate the content of the javascript file. Analyze the provided architecture carefully to create
...
async def get_js_file_content(
    ...
    try:
        ...
        validate_chat_response(response, get_js_file_generation_output_schema())
        response_dict = json.loads(response)
        return response_dict
    except Exception as e:
        print(f"Error in get_js_file_content: {e}")
        raise e
