...
instructions=f"""
Generate the content of the markdown file. Analyze the provided architecture carefully to create
...
async def get_md_file_content(
    ...
    try:
        ...
        validate_chat_response(response, get_md_file_generation_output_schema())
        response_dict = json.loads(response)
        return response_dict
    except Exception as e:
        print(f"Error in get_md_file_content: {e}")
        raise e